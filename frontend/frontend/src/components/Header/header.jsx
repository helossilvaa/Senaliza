                ...
                <div id="sidebar_content">
                    <div className="OpenClose d-flex justify-content-center align-items-center p-2">
                        <div className="senaiLogo">
                            {isExpanded && <img src="/Senalisa.png" href="/usuario/dashboard" className="logo" alt="Logo" />}
                        </div>
                    ...
                    <ul id="side_items">
                        <li className="side-item active mt-4">
                            <a href="/usuario/dashboard" className="d-flex align-items-center">
                                <i className="bi bi-speedometer2" />
                                <span className="item-description">Dashboard</span>
                            </a>
                        </li>
                        <li className="side-item">
                            <a href="/usuario/notificacoes" className="d-flex align-items-center">
                        ...
                        <li className="side-item">
                            <a href="/usuario/novoChamado" className="d-flex align-items-center">
